...
class STOPModel(nn.Module):
    ...
    def __init__(self, **model_params):
        ...
        self.encoder = STOP_Encoder(**model_params)
        self.decoder = STOP_Decoder(**model_params)
    ...
    def pre_forward(self, reset_state):
            ...
            node_prize = reset_state.node_prize                                     #new changes
            # shape: (batch, problem, 2)
