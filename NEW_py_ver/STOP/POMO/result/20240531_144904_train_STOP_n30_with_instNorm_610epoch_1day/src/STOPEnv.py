...
import torch
from STOPProblemDef import get_random_problems, augment_xy_data_by_8_fold
...
class STOPEnv: 
    ...
    def load_problems(self, batch_size, aug_factor=1) : 
        ...
        # shape: (batch, problem+1, 2)
        depot_prize = torch.zeros(size=(self.batch_size, 1, 2))
        # shape: (batch, 1, 2)
    ...
    def step(self, selected) : 
        ...
        self.remaining_len[self.at_the_depot & (self.day_finished < 2)] = 1.5 # reset length at the depot
