...
class OPHSModel(nn.Module):
    ...
    def forward(self, state):
        ...
        if state.selected_count == 0:  # First Move, depot
            ...
            selected = torch.arange(start=hotel_size, end=pomo_size+hotel_size)[None, :].repeat(batch_size, 1)        #change
