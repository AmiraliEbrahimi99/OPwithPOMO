...
tester_params = {
    ...
    'model_load': {
        'path': './result/20240725_101020_train_ophs_n20_with_instNorm_200_epoch',  # directory path of pre-trained model and log files saved.
...
class OPTester:
    ...
    def plot(self,batch : int = 0 , pomo : int = 0 , best_result : bool = False) :
        ...
        plt.scatter(self.plot_depot1[0], self.plot_depot1[1], color='red')
        plt.text(self.plot_depot1[0], self.plot_depot1[1], 'Depot 1', fontsize=12, ha='center', va='bottom')
        plt.scatter(self.plot_depot2[0], self.plot_depot2[1], color='blue')  # second depot
        plt.text(self.plot_depot2[0], self.plot_depot2[1], 'Depot 2', fontsize=12, ha='center', va='bottom')
